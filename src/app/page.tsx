    ...
    <main className="min-h-screen" style={{ background: "#F7F3EE", color: "#0E0C0A", fontFamily: "Georgia, serif" }}>
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "120px 48px 80px" }}>
        <div style={{ maxWidth: "640px" }}>
          ...
          <div style={{ display: "flex", gap: "14px", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <Link href="/register?role=artist" style={{ background: "transparent", color: "#0E0C0A", padding: "16px 36px", borderRadius: "6px", fontSize: "15px", fontWeight: 500, textDecoration: "none", border: "1.5px solid rgba(14,12,10,0.2)" }}>
              I&apos;m an Artist →
            </Link>
          </div>
      ...
      <section style={{ background: "#C8441A", textAlign: "center", padding: "100px 48px" }}>
        ...
        <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <Link href="/register?role=artist" style={{ background: "transparent", color: "white", padding: "16px 36px", borderRadius: "6px", fontSize: "15px", fontWeight: 500, textDecoration: "none", border: "2px solid rgba(255,255,255,0.4)" }}>
            Join as Artist
          </Link>
        </div>
      </section>
