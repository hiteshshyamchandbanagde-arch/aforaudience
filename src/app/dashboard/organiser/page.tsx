        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '48px 24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
            <div>
              ...
              <p style={{ fontSize: '14px', color: 'var(--afa-ink)', opacity: 0.6 }}>Create events, book venues, and review artist applications</p>
          ...
          {events.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '64px 24px', background: 'var(--afa-white)', borderRadius: '12px', border: '1px solid rgba(14,12,10,0.08)' }}>
              <p style={{ fontSize: '17px', color: 'var(--afa-ink)', marginBottom: '8px' }}>No events yet</p>
              <p style={{ fontSize: '14px', color: 'var(--afa-ink)', opacity: 0.6, marginBottom: '20px' }}>Create your first event to start booking venues and artists</p>
              <Link
                href="/dashboard/organiser/events/create"
              ...
              {events.map((event) => {
                ...
                return (
                  <div key={event.id} style={{ background: 'var(--afa-white)', borderRadius: '12px', padding: '24px', border: '1px solid rgba(14,12,10,0.08)' }}>
                    ...
                    <div style={{ display: 'flex', gap: '16px', marginBottom: '18px', fontSize: '13px', color: 'var(--afa-ink)', flexWrap: 'wrap' }}>
