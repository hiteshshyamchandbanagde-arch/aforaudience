  ...
  return (
    <div>
      ...
      <input
        ...
        style={{ width: '100%', padding: '10px 14px', borderRadius: 'var(--afa-radius-md)', border: '1px solid var(--afa-border-resting)', fontSize: 'var(--afa-text-body)', boxSizing: 'border-box', background: 'var(--afa-surface-raised)', color: 'var(--afa-text-primary)' }}
      />
    </div>
  )
}
