...
export default function PhotoCrossfadeBackdrop({
  ...
  return (
    <div style={{ position: "absolute", inset: 0 }}>
      {visiblePhotos.length > 0 ? (
        ...
        <div
          ...
          style={{
            position: "absolute",
            inset: 0,
            background: "radial-gradient(140% 140% at 18% 0%, var(--afa-ink) 0%, var(--afa-surface-inverse) 60%), linear-gradient(135deg, var(--afa-amber-wash) 0%, rgba(201,151,58,0) 50%)",
          }}
        />
      )}
      ...
      <div aria-hidden style={{ position: "absolute", inset: 0, background: "linear-gradient(90deg, var(--afa-scrim-strong), rgba(10,10,10,0) 55%)" }} />
      ...
      <div aria-hidden style={{ position: "absolute", inset: 0, zIndex: 1, background: "linear-gradient(180deg, var(--afa-surface-inverse) 0%, var(--afa-scrim) 8%, rgba(10,10,10,0) 20%)" }} />
    </div>
  )
}
