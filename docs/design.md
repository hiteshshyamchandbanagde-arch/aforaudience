...
Logged to the Feedback table as `BUG-2609-041` (`BUILD_COMPLETE`) -
the real `CodeCounter`-backed next sequence value, not a guessed
number (`currentSeq` was at 40; incremented atomically to 41). Not yet
merged - built on `fix/support-widget-dark-theme`, branched from `qa`
at `c36a6c8`.
