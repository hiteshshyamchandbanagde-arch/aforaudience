...
- GST e-commerce-operator registration was previously noted as "confirmed" in some earlier session context — this entry supersedes that with the accurate current state: GST is pending, not yet registered.
